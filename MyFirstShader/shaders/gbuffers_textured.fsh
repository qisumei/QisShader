...
void main() {
    ...
    float metallic = (int(matId + 0.5) == 20 || int(matId + 0.5) == 95 || int(matId + 0.5) == 160) ? 0.2 : 0.0;

    if (skyLight > 0.05 && NdotL > 0.0) {
        if (shadowUV.x >= 0.0 && shadowUV.x <= 1.0 && shadowUV.y >= 0.0 && shadowUV.y <= 1.0) {
            float currentBias = clamp(0.001 * tan(acos(NdotL)), 0.0002, 0.005);
    ...
    outData = vec4(metallic, 0.0, 0.0, 1.0);
}